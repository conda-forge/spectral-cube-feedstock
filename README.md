About spectral-cube-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spectral-cube-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3545&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spectral-cube-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spectral-cube` can be installed with `conda`:
...
```
mamba install spectral-cube
```

It is possible to list all of the versions of `spectral-cube` available on your platform with `conda`:
...
```
mamba search spectral-cube --channel conda-forge
```
...
mamba repoquery search spectral-cube --channel conda-forge

# List packages depending on `spectral-cube`:
mamba repoquery whoneeds spectral-cube --channel conda-forge

# List dependencies of `spectral-cube`:
mamba repoquery depends spectral-cube --channel conda-forge
```
